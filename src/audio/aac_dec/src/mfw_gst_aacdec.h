...
#ifndef __MFW_GST_AACDEC_H__
#define __MFW_GST_AACDEC_H__
...
=============================================================================*/
G_BEGIN_DECLS
#define MFW_GST_TYPE_AACDEC \
  (mfw_gst_aacdec_get_type())
#define MFW_GST_AACDEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),MFW_GST_TYPE_AACDEC,\
   MFW_GST_AACDEC_INFO_T))
#define MFW_GST_AACDEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),MFW_GST_TYPE_AACDEC,MFW_GST_AACDEC_CLASS_T))
#define MFW_GST_IS_AACDEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),MFW_GST_TYPE_AACDEC))
#define MFW_GST_IS_AACDEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),MFW_GST_TYPE_AACDEC))

/*=============================================================================
                                LOCAL MACROS
=============================================================================*/
#define LONG_BOUNDARY 4
#define	GST_CAT_DEFAULT    mfw_gst_aacdec_debug
...
typedef struct MFW_GST_AACDEC_INFO_S {
    GstElement element;
    GstPad *sinkpad;
    GstPad *srcpad;
...
typedef struct MFW_GST_AACDEC_CLASS_S {
    GstElementClass parent_class;
} MFW_GST_AACDEC_CLASS_T;
...
GType mfw_gst_aacdec_get_type(void);

G_END_DECLS
/*===========================================================================*/
#endif				/* __MFW_GST_AACDEC_H__ */
