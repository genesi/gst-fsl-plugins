...
mfw_gst_aacplusdec_base_init (MFW_GST_AACPLUSDEC_CLASS_T * klass)
{
    static GstElementDetails element_details = {
        ...
        "Codec/Decoder/Audio",
        "decodes AAC,AAC+SBR and Parmatric Stereo bitstreams",
...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR,   /* major version of Gstreamer    */
                   ...
                   "mfw_aacplusdecoder",        /* name of the plugin            */
                   "decodes AAC,AAC PLUS , ENHANCED AAC PLUS streams",  /* what plugin actually does     */
