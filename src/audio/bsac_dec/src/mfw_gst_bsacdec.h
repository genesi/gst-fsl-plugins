...
/*
 * Module Name:    mfw_gst_bsacdec.h
 *
 * Description:    Gstreamer plugin for AAC-BSAC decoder
 *
...
#ifndef __MFW_GST_BSACDEC_H__
#define __MFW_GST_BSACDEC_H__
...
=============================================================================*/
G_BEGIN_DECLS
#define MFW_GST_TYPE_BSACDEC \
  (mfw_gst_bsacdec_get_type())
#define MFW_GST_BSACDEC(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),MFW_GST_TYPE_BSACDEC,\
   MFW_GST_BSACDEC_INFO_T))
#define MFW_GST_BSACDEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),MFW_GST_TYPE_BSACDEC,MFW_GST_BSACDEC_CLASS_T))
#define MFW_GST_IS_BSACDEC(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),MFW_GST_TYPE_BSACDEC))
#define MFW_GST_IS_BSACDEC_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),MFW_GST_TYPE_BSACDEC))
/*=============================================================================
...
typedef struct MFW_GST_BSACDEC_INFO_S {
    GstElement element;
    GstPad *sinkpad;
    GstPad *srcpad;
...
typedef struct MFW_GST_BSACDEC_CLASS_S {
    GstElementClass parent_class;
} MFW_GST_BSACDEC_CLASS_T;
