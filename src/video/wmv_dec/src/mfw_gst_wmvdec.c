...
static GstElementDetails mfw_gst_wmvdec_details =
...
static eWmv9DecRetType mfw_gst_wmv_decode(MFW_GST_WMVDEC_INFO_T * wmvdec)
{
    ...
    if (wmvdec->caps_set == FALSE) {
        ...
        gst_caps_unref(caps);
        caps = NULL;
        mfw_gst_wmvdec_sink_event(wmvdec->srcpad,
...
static void mfw_gst_wmvdec_base_init(gpointer klass)
{
    ...
    gst_element_class_set_details(element_class, &mfw_gst_wmvdec_details);
...
GST_PLUGIN_DEFINE(GST_VERSION_MAJOR,    /* major version of gstreamer       */
          ...
          "mfw_wmvdecoder",    /* name of our wmvdecoder plugin    */
